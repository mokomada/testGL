...
void CGame::Init(void)
{
	...
	m_Player.resize(4);
	m_Player[0] = CPlayer::Create(0, VECTOR3(0.0f, 50.0f, 0.0f));
	m_Player[1] = CPlayer::Create(1, VECTOR3(-100.0f, 50.0f, 0.0f));
	m_Player[2] = CPlayer::Create(2, VECTOR3(100.0f, 50.0f, 0.0f));
	m_Player[3] = CPlayer::Create(3, VECTOR3(0.0f, 50.0f, 100.0f));
