...
void CGame::Init(void)
{
	...
	CSquare::Create(VECTOR3(0.0f, 0.0f, 2500.0f), VECTOR3(5000.0f, 100.0f, 50.0f), "./data/TEXTURE/主ちゃ.png", VECTOR4(1.0f, 1.0f, 1.0f, 1.0f));
	CSquare::Create(VECTOR3(0.0f, 0.0f, -2500.0f), VECTOR3(5000.0f, 100.0f, 50.0f), "./data/TEXTURE/主ちゃ.png", VECTOR4(1.0f, 1.0f, 1.0f, 1.0f));
	CSquare::Create(VECTOR3(2500.0f, 0.0f, 0.0f), VECTOR3(50.0f, 100.0f, 5000.0f), "./data/TEXTURE/主ちゃ.png", VECTOR4(1.0f, 1.0f, 1.0f, 1.0f));
	CSquare::Create(VECTOR3(-2500.0f, 0.0f, 0.0f), VECTOR3(50.0f, 100.0f, 5000.0f), "./data/TEXTURE/主ちゃ.png", VECTOR4(1.0f, 1.0f, 1.0f, 1.0f));
