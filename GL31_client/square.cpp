...
void CSquare::Draw(void)
{
	...
	glNormal3f(0.0f, 1.0f, 0.0f);
	glTexCoord2d(m_Square.pos.x / SQUARE_SIZE_MAX, 0.0f);
	glColor4f( m_Color.x, m_Color.y, m_Color.z, m_Color.w );	//色(RGBA)
	glVertex3f( m_Square.pos.x , -m_Square.pos.y , -m_Square.pos.z );

	glNormal3f(0.0f, 1.0f, 0.0f);
	glTexCoord2d(0.0f, m_Square.pos.z / SQUARE_SIZE_MAX);
	glColor4f( m_Color.x, m_Color.y, m_Color.z, m_Color.w );	//色(RGBA)
	glVertex3f(-m_Square.pos.x , -m_Square.pos.y , m_Square.pos.z );

	glNormal3f(0.0f, 1.0f, 0.0f);
	glTexCoord2d(m_Square.pos.x / SQUARE_SIZE_MAX, m_Square.pos.z / SQUARE_SIZE_MAX);
	glColor4f( m_Color.x, m_Color.y, m_Color.z, m_Color.w );	//色(RGBA)
	glVertex3f( m_Square.pos.x , -m_Square.pos.y , m_Square.pos.z );
	...
	glNormal3f(0.0f, 1.0f, 0.0f);
	glTexCoord2d(0.0f, m_Square.pos.y / SQUARE_SIZE_MAX);
	glColor4f( m_Color.x, m_Color.y, m_Color.z, m_Color.w );	//色(RGBA)
	glVertex3f(-m_Square.pos.x , -m_Square.pos.y , m_Square.pos.z );

	glNormal3f(0.0f, 1.0f, 0.0f);
	glTexCoord2d(m_Square.pos.x / SQUARE_SIZE_MAX, m_Square.pos.y / SQUARE_SIZE_MAX);
	glColor4f( m_Color.x, m_Color.y, m_Color.z, m_Color.w );	//色(RGBA)
	glVertex3f( m_Square.pos.x , -m_Square.pos.y , m_Square.pos.z );
...
//上の面
	...
	glNormal3f(0.0f, 1.0f, 0.0f);
	glTexCoord2d(m_Square.pos.z / SQUARE_SIZE_MAX, 0.0f);
	glColor4f( m_Color.x, m_Color.y, m_Color.z, m_Color.w );	//色(RGBA)
	glVertex3f( m_Square.pos.x , m_Square.pos.y , m_Square.pos.z );
	...
	glNormal3f(0.0f, 1.0f, 0.0f);
	glTexCoord2d(m_Square.pos.z / SQUARE_SIZE_MAX, m_Square.pos.y / SQUARE_SIZE_MAX);
	glColor4f( m_Color.x, m_Color.y, m_Color.z, m_Color.w );	//色(RGBA)
	glVertex3f( m_Square.pos.x , -m_Square.pos.y , m_Square.pos.z );
